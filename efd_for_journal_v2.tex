...
\begin{table*}[ht]
    ...
    \hline
		...
		8Mbit/s & mean & 392.4961 & 176.8407 & 1.9997 \\ \cline{2-5}
		(underload) & 95\%-CI & [392.3759,  392.6163] & [176.7861,  176.8952] & [1.9962,    2.0032] \\ \hline
		15Mbit/s & mean & 704.0326 & 352.9599 & 27.9053 \\ \cline{2-5}
		(overload) & 95\%-CI & [703.8622,  704.2030] & [352.8678,  353.0519] & [27.8824,   27.9282] \\ \hline	
    \end{tabular}
		}
...
\begin{figure*}[ht!]
  \centering
  \subfigure[all flow sizes]{\includegraphics[width=0.495\textwidth]{./fig/analysis/issue_two/mg1_variant_fs_exp_5_0.eps}}
