...
We propose two adaptations of EFD in WLAN networks, EFDACK and PEFD,  that aim at mitigating the TCP unfairness problem. EFDACK relied on the same idea as LAS and LARS adaptations: keeping  track of the amount of bytes sent by each flow in both the upload and download directions. %, which requires reading TCP segments (the acknowledgment number field) within IP packets. This is the same idea as the one of LASACK \cite{Keller2008Improving}. 
...
\begin{figure}[ht]
  \centering
  \subfigure[workload of 8Mbit/s (underload)]{\label{fig:wifib-01}\includegraphics[width=0.49\textwidth]{./fig/wired/internal_dynamics/slpktsub_8}}
  \subfigure[workload of 15Mbit/s (overload)]{\label{fig:wifia-01}\includegraphics[width=0.49\textwidth]{./fig/wired/internal_dynamics/slpktsub_20}}  
...
\begin{figure}[ht]%placement
   \centering
  \includegraphics[width=0.8\textwidth]{./fig/flow-split}%chemin 
...
%  \subfigure[Subflows in two queues - prctile]{\includegraphics[width=0.495\textwidth]{./Part1/Chapter4/fig/chapter_one/mg1_prctile_queue_5.eps}}  	
  \subfigure[CDF]{\includegraphics[width=0.495\textwidth]{./fig/analysis/mg1_cdf_bp_5_all}}
  \subfigure[Mass-Weighted Distribution]{\includegraphics[width=0.495\textwidth]{./fig/analysis/mg1_prctile_bp_5_all}}          
...
\begin{figure}[ht!]
   \centering
    %\includegraphics[width=0.55\textwidth]{./udp3/loss/udp_loss_8.eps}
  	\subfigure[a CBR flow with rate of 64Kb/s]{\includegraphics[width=0.49\textwidth]{./fig/wired/multimedia/loss_64/udp_loss}}
  	\subfigure[a CBR flow with rate of 500Kb/s]{\includegraphics[width=0.49\textwidth]{./fig/wired/multimedia/loss_500/udp_loss}}   
...
\begin{figure}[ht]
  \centering
  \subfigure[CDF of inter-departure times for a CBR flow with 4Mb/s background traffic]{\includegraphics[width=0.49\textwidth]{./fig/wired/multimedia/jitter_64/inter_time_4}}  
  \subfigure[CDF of inter-departure times for a CBR flow with 12Mb/s background traffic]{\includegraphics[width=0.49\textwidth]{./fig/wired/multimedia/jitter_64/inter_time_12}}     
...
\begin{figure*}[ht!]
  \centering
  \subfigure[Workload of 10Mbit/s]{\includegraphics[width=0.495\textwidth]{./fig/wireless/4schemes/byte/mg1_tw_fs_exp_10_0}}
  \subfigure[Workload of 20Mbit/s]{\includegraphics[width=0.495\textwidth]{./fig/wireless/4schemes/byte/mg1_tw_fs_exp_20_0}}  
...
\begin{figure*}[ht!]
  \centering
  \subfigure[Workload of 10Mbit/s]{\includegraphics[width=0.495\textwidth]{./fig/wireless/4schemes/pkt/mg1_tw_fs_exp_10_0}}
  \subfigure[Workload of 20Mbit/s]{\includegraphics[width=0.495\textwidth]{./fig/wireless/4schemes/pkt/mg1_tw_fs_exp_20_0}}  
...
\begin{figure*}[ht!]
  \centering
  \subfigure[Workload of 10Mbit/s]{\includegraphics[width=0.495\textwidth]{./fig/wireless/latency/sym/mg1_tw_fs_exp_10_0}}
  \subfigure[Workload of 20Mbit/s]{\includegraphics[width=0.495\textwidth]{./fig/wireless/latency/sym/mg1_tw_fs_exp_20_0}}  
...
\begin{figure*}[ht!]
  \centering
  \subfigure[Workload of 10Mbit/s]{\includegraphics[width=0.495\textwidth]{./fig/wireless/latency/asym/mg1_tw_fs_exp_10_0}}
  \subfigure[Workload of 20Mbit/s]{\includegraphics[width=0.495\textwidth]{./fig/wireless/latency/asym/mg1_tw_fs_exp_20_0}}  
...
\begin{figure*}[ht!]
  \centering
  \subfigure[Workload of 10Mbit/s]{\includegraphics[width=0.495\textwidth]{./fig/wireless/buffersize/large/asym/mg1_tw_fs_exp_10_0}}
  \subfigure[Workload of 20Mbit/s]{\includegraphics[width=0.495\textwidth]{./fig/wireless/buffersize/large/asym/mg1_tw_fs_exp_20_0}}  
